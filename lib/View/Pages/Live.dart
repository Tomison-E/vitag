...
class LiveState extends State<LivePage> {
  ...
  void initialize() {
    ...
    _addRenderView(0, (viewId) {
      ...
      AgoraRtcEngine.joinChannel(null, _channelName, null, 0);
    });
  }
  ...
  icon: Container( child:new Icon(Icons.stop,color: Colors.redAccent,size: 35.0,),decoration: BoxDecoration(color: Colors.white,shape: BoxShape.circle),margin: EdgeInsets.only(left: 8.0),),
  onPressed: () {
